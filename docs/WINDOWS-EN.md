...
5. Connect the tablet to the same home network and scan the QR code. For another tablet, use **Settings → Connect a tablet**.

Keep the computer switched on and awake. After restarting Windows, open the desktop aquarium shortcut. The tablet is a display, not the server.
